...
describe "prospective_properties/edit" do
  before(:each) do
    @prospective_property = assign(:prospective_property, stub_model(ProspectiveProperty,
      :address => "MyString",
      :city => "MyString",
      :state => "MyString",
      :zip => "MyString",
  ...
  it "renders the edit prospective_property form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => prospective_properties_path(@prospective_property), :method => "post" do
